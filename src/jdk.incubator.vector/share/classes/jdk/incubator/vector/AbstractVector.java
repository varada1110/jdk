...
abstract class AbstractVector<E> extends Vector<E> {
    ...
    /* Generic builder: reverse-within-each-group-of-k for target species */
    @ForceInline
    ...
    abstract AbstractVector<E> maybeSwapOnConverted(ByteOrder bo, AbstractSpecies<?> srcSpecies);
